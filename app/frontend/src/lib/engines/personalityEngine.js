...
export function computePersonality(transactions) {
...
export function computeRoastScore(transactions) {
  const m = computeMetrics(transactions)
  if (!m) return 0
  const raw =
    m.chaosNorm * 40 +
...
export function roastScoreLabel(score) {
...
export function computeAchievements(transactions) {
