...
export default function MonthlyOverview({ transactions }) {
  ...
  const items = [['MONTHLY INCOME', overview.totalIncome, ArrowDownLeft, 'value-primary'], ['MONTHLY EXPENSES', overview.totalExpenses, ArrowUpRight, 'value-neutral'], ['MONTHLY BALANCE', overview.totalBalance, Scale, 'value-primary']]
